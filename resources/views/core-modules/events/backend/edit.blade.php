			...
			<form method="post" enctype="multipart/form-data" class="submit-once">
				<div class="card-body">
					<div class="col-sm-10">
						...
						<div class="form-group">
							<img src="{{ route('get-asset', ['events', $data->asset]) }}" alt="{{ $data->title }}" height="150px">
						...
						<div class="form-group">
							...
							<textarea name="data[long_description]" class="form-control" rows="5" required>{{ str_replace("<br />", "\n", $data->long_description) }}</textarea>
						...
						<div class="form-group">
							...
							<input id="start_date" type="text" name="data[start_date]" class="date form-control start_date" required value="{{ $data->start_date }}">
						...
						<div class="form-group">
							...
							<input id="end_date" type="text" name="data[end_date]" class="date form-control end_date" required value="{{ $data->end_date }}">
						...
						<div class="form-group">
							...
							<input id="deadline" type="text" name="data[deadline]" class="date form-control deadline" required value="{{ $data->deadline }}">
						...
						<div class="form-group">
							...
							<input id="event_time" type="text" name="data[event_time]" class="form-control event_time" value="{{ $data->event_time }}">
						...
						<div class="form-group">
							...
							<input id="location" type="text" name="data[location]" class="form-control location" required value="{{ $data->location }}">
