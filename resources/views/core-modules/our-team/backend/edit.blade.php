				...
				<div class="card-body">
					<div class="col-sm-10">
						<div class="form-group">
							...
							<input id="name" type="text" name="data[name]" class="form-control name" required value="{{ $data->name }}">
						...
						@if($data->asset)
							<img src="{{ route('get-asset', ['our-team', $data->asset]) }}" alt="{{ $data->name }}" class="img img-responsive" width=150px/>
						@endif
						...
						<div class="form-group">
							...
							<input id="position" type="text" name="data[position]" class="form-control position" required value="{{ $data->position }}">
						...
						<div class="form-group">
							...
							<textarea name="data[description]" class="form-control" rows="5">{{ str_replace("<br />", "\n", $data->description) }}</textarea>
