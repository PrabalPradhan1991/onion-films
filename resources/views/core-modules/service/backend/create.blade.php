				...
				<div class="card-body">
					<div class="col-sm-10">
						<div class="form-group">
							...
							<input id="service" type="text" name="data[service]" class="form-control service" required value="{{ request()->old('data.service') }}">
						...
						<div class="form-group">
							...
							<input id="icon" type="text" name="data[icon]" class="form-control icon" required value="{{ request()->old('data.icon') }}">
