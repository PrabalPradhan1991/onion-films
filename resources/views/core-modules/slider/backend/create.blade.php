				...
				<div class="card-body">
					<div class="col-sm-10">
						<div class="form-group">
							...
							<input id="asset" type="file" name="data[asset]" class="form-control asset" required accept="image/jpg, image/png, image/webp, video/webm, video/mp4">
						...
						<div class="form-group">
							...
							<textarea name="data[intro_text]" class="form-control" rows="5">{{ request()->old('data.intro_text') }}</textarea>
						...
						<div class="form-group">
							...
							<input id="link" type="text" name="data[link]" class="form-control link" value="{{ request()->old('data.link') }}">
							@if($errors->has('link'))
