			...
			<form method="post" enctype="multipart/form-data" class="submit-once">
				<div class="card-body">
					<div class="col-sm-10">
						...
						@if($data->asset)
							<img src="{{ route('get-asset', [$client_storage_folder, $data->asset]) }}" alt="{{ $data->client }}" class="img img-responsive" width=150px/>
						@endif

						<div class="form-group">
							<label for="asset">Logo</label>
							<input type="file" name="data[asset]" accept="image/png, image/webp">
