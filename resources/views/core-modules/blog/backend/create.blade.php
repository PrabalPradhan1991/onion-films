				...
				<div class="card-body">
					<div class="col-sm-10">
						...
						<div class="form-group">
							...
							<input id="sub_title" type="text" name="data[sub_title]" class="form-control sub_title" required value="{{ request()->old('data.sub_title') }}">
						...
						<div class="form-group">
							...
							<textarea name="data[long_description]" class="form-control summernote" rows="5">{{ request()->old('data.long_description') }}</textarea>
						...
						<div class="form-group">
							...
							<input id="tags" type="text" name="data[tags]" class="form-control tags" required value="{{ request()->old('data.tags') }}">
						...
						<div class="form-group">
							...
							<input id="author" type="text" name="data[author]" class="form-control author" required value="{{ request()->old('data.author') }}">
						...
						<div class="form-group">
							...
							<input id="publish_date" type="text" name="data[publish_date]" class="date form-control publish_date" required value="{{ request()->old('data.publish_date') }}">
						...
						<div class="form-group">
							...
							<input id="seo_title" type="text" name="data[seo_title]" class="form-control seo_title" value="{{ request()->old('data.seo_title') }}">
						...
						<div class="form-group">
							...
							<input id="seo_keywords" type="text" name="data[seo_keywords]" class="form-control seo_keywords" value="{{ request()->old('data.seo_keywords') }}">
						...
						<div class="form-group">
							...
							<textarea id="seo_description" type="text" name="data[seo_description]" class="form-control seo_description" rows="5">{{ request()->old('data.seo_description') }}</textarea>
